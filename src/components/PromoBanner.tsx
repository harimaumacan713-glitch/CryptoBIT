    ...
    <div className="bg-gradient-to-r from-indigo-950 via-[#10132C] to-slate-950 rounded-lg p-5 text-white flex items-center justify-between cursor-pointer hover:border-[#00AE64]/30 border border-slate-800 transition-all duration-300 group mb-4 shadow-xl">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <h3 className="font-extrabold text-base tracking-tight text-white group-hover:text-[#00AE64] transition-colors">VIA X Pro Features : Web3 Technical Session</h3>
          <p className="text-xs text-slate-400 mt-1">VIA X Academy • Exclusive Developer Masterclass</p>
        </div>
      </div>
